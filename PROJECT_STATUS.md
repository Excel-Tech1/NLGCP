...
| Phase 8 — Hybrid Correction Decision Engine | Validation | Fail-closed correction-mode decision (VRS / single-base / no-correction) with versioned policy, upstream Phase 6/7 contracts, provenance, and real DOY 026 pilot; automatic VRS stays BLOCKED pending Phase 6/7 review |
